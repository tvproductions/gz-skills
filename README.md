...
The latest immutable bundle release is `v0.3.1`; `v0.2.0` was the first. The
...
- Codex can install the released bundle from this repository marketplace:
  ...
  ```text
  codex plugin marketplace add tvproductions/gz-skills@v0.3.1
...
- OpenCode can install the git-backed package through its own plugin manager:
  ...
  ```json
  {
    ...
    "plugin": [
      "gz-skills@git+https://github.com/tvproductions/gz-skills.git#v0.3.1"
    ]
  }
  ```
